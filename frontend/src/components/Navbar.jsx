...
import { logo, logo1, menu, search, thirdweb } from '../assets';
    ...
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      ...
      {/* Small screen navigation */}
        ...
        <div className="w-[40px] h-[40px] rounded-[10px] bg-button flex justify-center items-center cursor-pointer">
          ...
          <div className={`absolute top-[60px] right-0 left-0 bg-secondary z-10 shadow-secondary py-4 ${!toggleDrawer ? '-translate-y-[100vh]' : 'translate-y-0'} transition-all duration-700`}>
            <ul className="mb-4">
              {navlinks.map((link) => (
                <li
                  key={link.name}
